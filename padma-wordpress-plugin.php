...
require_once( PADMA_PLUGIN_DIR . 'includes/logger.php' );

require_once( PADMA_PLUGIN_DIR . 'includes/filter-data.php' );
...
require_once( PADMA_PLUGIN_DIR . "includes/hook-into-wpforms-lite.php" );
